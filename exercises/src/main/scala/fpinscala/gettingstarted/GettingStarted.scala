...
object MyModule {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(PolymorphicFunctions.isSorted(sorted, (a: Int, b: Int) => a > b))
    val unsorted = Array(1, 5, 3, 4)
    println(PolymorphicFunctions.isSorted(unsorted, (a: Int, b: Int) => a > b))
  }
  ...
  def fib(n: Int): Int = {
    @annotation.tailrec
    def go(limit: Int, f1: Int, f2: Int): Int =
      if (limit < n) go(limit+1, f1+f2, f1)
      else f2
